        ...
        <div class="nk-header-wrap">
            ...
            <div class="nk-header-brand d-xl-none">
                <a href="{{ route('admin.dashboard') }}" class="logo-link">
                    <img class="logo-light logo-img" src="{{ asset('assets/admin/img/app_logo.png') }}" alt="logo">
                    <img class="logo-dark logo-img" src="{{ asset('assets/admin/img/app_logo.png') }}" alt="logo-dark">
                </a>
            </div>
