                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <select class="form-select js-select2 @error('default_language') is-invalid @enderror"
                                            ...
                                            <option value="select_language" disabled {{ old('default_language', $data->default_language) ? '' : 'selected' }}>Select Language</option>
                                            @foreach ([
                                                'en' => 'English',
                                                'hi' => 'Hindi',
                                                'mr' => 'Marathi',
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <select class="form-select js-select2 @error('date_format') is-invalid @enderror"
                                            ...
                                            <option value="select_date_format" disabled {{ old('date_format', $data->date_format) ? '' : 'selected' }}>Select Date Format</option>
                                            @foreach ([
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <select class="form-select js-select2 @error('time_format') is-invalid @enderror"
                                            ...
                                            <option value="select_time_format" disabled {{ old('time_format', $data->time_format) ? '' : 'selected' }}>Select Time Format</option>
                                            @foreach ([
                                                'H:i' => now()->format('H:i'),
