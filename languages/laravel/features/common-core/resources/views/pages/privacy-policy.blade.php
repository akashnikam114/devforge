    ...
    <div class="relative py-16 sm:py-24 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 text-center">
            ...
            <h1 class="text-5xl md:text-7xl font-black tracking-tight text-slate-900 mb-6">
                Privacy <span class="text-transparent bg-clip-text theme-gradient">Policy</span>
            </h1>

            <p class="text-slate-500 text-lg font-medium max-w-xl mx-auto leading-relaxed">
                Your trust is our priority. Below you'll find a clear breakdown of how we protect your data at <span class="text-slate-900 font-bold">{{ $appSetting::getBusinessInfo('app_name') }}.</span>
            </p>
