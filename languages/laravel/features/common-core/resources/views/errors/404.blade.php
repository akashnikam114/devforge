...
<body class="bg-slate-50 flex flex-col items-center justify-center min-h-screen p-4">
    <div class="w-full max-w-lg bg-white rounded-[1.5rem] md:rounded-[2rem] p-8 md:p-12 shadow-xl shadow-slate-200 text-center border-t-4 theme-border">
        ...
        <div class="inline-block p-4 theme-bg-soft rounded-2xl mb-6">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 md:w-12 md:h-12 theme-stroke" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <h1 class="text-4xl md:text-5xl font-black theme-text tracking-tight mb-1">404</h1>
