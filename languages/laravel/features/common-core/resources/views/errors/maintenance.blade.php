...
<body class="bg-slate-50 flex flex-col items-center justify-center min-h-screen p-4">
    <div class="w-full max-w-lg bg-white rounded-[1.5rem] md:rounded-[2rem] p-8 md:p-12 shadow-xl shadow-slate-200 text-center border-t-4 border-[#049C9C]">
        <div class="float-icon mb-6 inline-flex p-5 rounded-full bg-white shadow-sm border border-slate-100">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10" viewBox="0 0 24 24" fill="none" stroke="#049C9C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="grid grid-cols-3 gap-4 mb-10">
            <div class="bg-slate-50 p-3 rounded-xl border border-slate-100 shadow-sm">
                <span id="hours" class="block text-2xl font-black text-[#049C9C]">24</span>
                <span class="text-[10px] uppercase font-bold text-slate-400 tracking-widest">Hours</span>
            </div>
            <div class="bg-slate-50 p-3 rounded-xl border border-slate-100 shadow-sm">
                <span id="minutes" class="block text-2xl font-black text-[#049C9C]">00</span>
                <span class="text-[10px] uppercase font-bold text-slate-400 tracking-widest">Minutes</span>
            </div>
            <div class="bg-slate-50 p-3 rounded-xl border border-slate-100 shadow-sm">
                <span id="seconds" class="block text-2xl font-black text-[#049C9C]">00</span>
