        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    ...
                    <h3 class="nk-block-title page-title">Edit App Release</h3>
                    <div class="nk-block-des">
                        <p>Update existing app release details</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="nk-block nk-block-lg mt-3">
            <div class="card card-bordered card-preview col-sm-8">
                <div class="card-inner">
                    <form method="POST" action="{{ url('admin/app_releases/edit') }}/{{ $data->id }}">
                        @csrf
                        <div class="row g-4">
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control form-control-lg @error('latest_version') is-invalid @enderror" name="latest_version" id="latest_version" value="{{ old('latest_version', $data->latest_version) }}" placeholder="e.g. 1.0.0">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="custom-control-md text-start custom-switch" style="margin-top: 2px;">
                                        <input type="checkbox" class="custom-control-input" id="is_force_update" name="is_force_update" value="1" {{ old('is_force_update', $data->is_force_update) == 1 ? 'checked' : '' }}>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <textarea class="form-control form-control-lg @error('release_notes') is-invalid @enderror" name="release_notes" id="release_notes" rows="4" placeholder="What's new?">{{ old('release_notes', $data->release_notes) }}</textarea>
                                        @error('release_notes')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
